...
func (x *OrderFromCartRequest) Reset() {
	*x = OrderFromCartRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *OrderFromCartRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderFromCartRequest) ProtoMessage() {}

func (x *OrderFromCartRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_pb_order_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderFromCartRequest.ProtoReflect.Descriptor instead.
func (*OrderFromCartRequest) Descriptor() ([]byte, []int) {
	return file_pkg_pb_order_proto_rawDescGZIP(), []int{2}
}

func (x *OrderFromCartRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_pkg_pb_order_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x2e, 0x0a, 0x14, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x46, 0x72, 0x6f, 0x6d, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0x9e, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
	...
	0x48, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d, 0x43, 0x61, 0x72, 0x74,
	0x12, 0x1b, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46, 0x72,
	...
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x70,
...
var file_pkg_pb_order_proto_goTypes = []interface{}{
	...
	(*OrderFromCartRequest)(nil), // 2: order.OrderFromCartRequest
}
var file_pkg_pb_order_proto_depIdxs = []int32{
	0, // 0: order.OrderService.CreateOrder:input_type -> order.CreateOrderRequest
	2, // 1: order.OrderService.OrderFromCart:input_type -> order.OrderFromCartRequest
	1, // 2: order.OrderService.CreateOrder:output_type -> order.CreateOrderResponse
	1, // 3: order.OrderService.OrderFromCart:output_type -> order.CreateOrderResponse
...
func file_pkg_pb_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_pb_order_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OrderFromCartRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
